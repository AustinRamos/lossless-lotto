...
import "./LottoController.sol";
import "@openzeppelin/contracts/access/Ownable.sol";


//ok slowly keep building up from here... 

//look up isownable stuff..
contract Lotto {


    //for lotto controller:
    uint256 id;
    //varianles
    LottoController public controller;
...
//********* */
//so dont call start lottery, or rather constructor calls start lottery?
    constructor(address LottoControllerAddress, uint256 _id){
    controller = LottoController(controller);
    hasStarted=false;
...
//     //passes in LottoController address? and this can tell what can be done?



//     //constructor(address LottoController) {
//            constructor( ) {
//         hasStarted=false;
//         hasEnded=false;
//         lengthOfLottery = 150000; //15 minutes
